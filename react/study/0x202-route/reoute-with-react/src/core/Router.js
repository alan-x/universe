...
//         location.hash = this.combineHash(path, data)
//     }
//
//     static init(container, config) {
//         window.addEventListener('hashchange', () => {
//             const route = config[this.getHash()]
//             LeactDom.render(new route.component(this.queryStringToParam()), container)
//         })
//         const route = config[this.getHash()]
//         LeactDom.render(new route.component(this.queryStringToParam()), container)
//     }
...
//         if (!Object.keys(data).length) return path
//         return path + '?' + this.paramToQueryString(data)
//     }
// }
//
...
class Router {
    ...
    static init() {
        ...
        Object.values(this.routes).forEach(route => {
            route.callback(this.queryStringToParam(), this.routes['/' + this.getPath()].route)
        })
